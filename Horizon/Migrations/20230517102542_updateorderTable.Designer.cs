...
namespace Horizon.Migrations
{
    ...
    [Migration("20230517102542_updateorderTable")]
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 5, 17, 13, 25, 42, 118, DateTimeKind.Local).AddTicks(1572),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 5, 17, 13, 25, 42, 118, DateTimeKind.Local).AddTicks(1553),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
