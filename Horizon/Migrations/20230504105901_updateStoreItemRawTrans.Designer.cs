...
namespace Horizon.Migrations
{
    ...
    [Migration("20230504105901_updateStoreItemRawTrans")]
    partial class updateStoreItemRawTrans
    {
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 5, 4, 13, 59, 0, 959, DateTimeKind.Local).AddTicks(1930),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 5, 4, 13, 59, 0, 959, DateTimeKind.Local).AddTicks(1918),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
