...
namespace Horizon.Migrations
{
    ...
    [Migration("20230517123004_updateOrderConfigureTable")]
    partial class updateOrderConfigureTable
    {
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 5, 17, 15, 30, 4, 149, DateTimeKind.Local).AddTicks(1419),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 5, 17, 15, 30, 4, 149, DateTimeKind.Local).AddTicks(1407),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
