...
namespace Horizon.Migrations
{
    ...
    [Migration("20230515141537_addPropertyInOrderDetails")]
    partial class addPropertyInOrderDetails
    {
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 5, 15, 17, 15, 37, 325, DateTimeKind.Local).AddTicks(1230),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 5, 15, 17, 15, 37, 325, DateTimeKind.Local).AddTicks(1217),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
