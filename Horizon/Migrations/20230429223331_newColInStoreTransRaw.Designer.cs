...
namespace Horizon.Migrations
{
    ...
    [Migration("20230429223331_newColInStoreTransRaw")]
    partial class newColInStoreTransRaw
    {
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 4, 30, 0, 33, 30, 899, DateTimeKind.Local).AddTicks(5909),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 4, 30, 0, 33, 30, 899, DateTimeKind.Local).AddTicks(5895),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
