...
namespace Horizon.Migrations
{
    ...
    [Migration("20230516084128_convertInvoiceNum_in_manufact_ToString")]
    partial class convertInvoiceNum_in_manufact_ToString
    {
            ...
            modelBuilder.Entity("Horizon.Areas.Store.Models.Settings.RawItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "",
                            DateCreated = new DateTime(2023, 5, 16, 11, 41, 27, 944, DateTimeKind.Local).AddTicks(535),
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 5, 16, 11, 41, 27, 944, DateTimeKind.Local).AddTicks(519),
                            ModifiedBy = "",
                            RawItemTypeName = "صاج"
                        });
                });
